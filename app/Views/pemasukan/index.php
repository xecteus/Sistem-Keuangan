...
<form action="/pemasukan/caritanggal" method="post">
    <div class="row">
        <div class="col-sm-12">
            <div class="form-row">
                <div class="form-group col-md">
                    <div class="input-group mb-2">
                        ...
                        <div class="col-sm">
                            <a href="/pemasukan" class="btn btn-secondary">Refresh</a>
                        </div>
                        <!-- <a href="/pemasukan/create" class="btn btn-success btn-icon-split">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control kode_pemasukan" name="kode_pemasukan" readonly>
                    </div>
