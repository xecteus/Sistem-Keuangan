...
<ul class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="/transaksipengeluaran"><?= $breadcrumb; ?></a></li>
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Tambah Transaksi Pengeluaran</h6>
    </div>
    <div class="card-body">
        <form action="/transaksipengeluaran/save" method="post">
            <?= csrf_field(); ?>
            <div class="form-group row">
                <label for="kode_trans" class="col-sm-2 col-form-label">Kode Transaksi</label>
                <div class="col-sm-2">
                    <input type="text" value=<?= $kodePembelian; ?> class="form-control" id="kode_trans" name='kode_trans' readonly>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    <input type="text" value="" class="form-control <?= ($validation->hasError('kategori')) ? 'is-invalid' : ''; ?>" id="kategori" name='kategori' value="<?= old('kategori'); ?>">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-5">
                    <textarea class="form-control <?= ($validation->hasError('keterangan')) ? 'is-invalid' : ''; ?>" rows="3" id="keterangan" name='keterangan' value="<?= old('keterangan'); ?>"></textarea>
                    <div class="invalid-feedback">
