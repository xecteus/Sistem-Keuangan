...
<ul class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="/purchasing"><?= $breadcrumb; ?></a></li>
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Tambah Transaksi Pembelian</h6>
    </div>
    <div class="card-body">
        <form action="/purchasing/save" method="post">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    <input type="text" value="Pembelian" class="form-control" id="kategori" name='kategori' readonly>
                </div>
            </div>
