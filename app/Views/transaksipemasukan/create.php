...
<ul class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="/transaksipemasukan"><?= $breadcrumb; ?></a></li>
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Tambah Transaksi Pemasukan</h6>
    </div>
    <div class="card-body">
        <form action="/transaksipemasukan/save" method="post">
            <?= csrf_field(); ?>
