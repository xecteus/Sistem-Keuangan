...
<form action="/transaksipemasukan/caritanggal" method="post">
    <div class="row">
        <div class="col-sm-12">
            <div class="form-row">
                <div class="form-group col-md">
                    <div class="input-group mb-2">
                        ...
                        <div class="col-sm">
                            <a href="/transaksipemasukan" class="btn btn-secondary">Refresh</a>
                        </div>
                        <a href="/transaksipemasukan/create" class="btn btn-success btn-icon-split">
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Data Transaksi Pemasukan</h6>
    </div>
    <div class="card-body">
...
<!-- Modal Edit Product-->
<form action="/transaksipemasukan/update" method="post">
...
<form action="/transaksipemasukan/delete" method="post">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <h6>Anda yakin ingin menghapus Pemasukan ?</h6>
