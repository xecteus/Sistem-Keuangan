...
<form action="/pembelian/caritanggal" method="post">
    <div class="row">
        <div class="col-sm-12">
            <div class="form-row">
                <div class="form-group col-md">
                    <div class="input-group mb-2">
                        ...
                        <div class="col-sm">
                            <a href="/pembelian" class="btn btn-secondary">Refresh</a>
                        </div>
                        <a href="/pembelian/create" class="btn btn-success btn-icon-split">
...
<form action="/pembelian/delete" method="post">
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Delete Pembelian</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    ...
                    <h6>Anda yakin ingin menghapus pembelian ?</h6>
...
<!-- Modal Print Product-->
<form action="/pembelian/invoice" method="post">
